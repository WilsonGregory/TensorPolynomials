...
models_list = [
    ('baselineLearned', 1e-3, models.BaselineLearnedModel(n, d, width, depth, subkey1)), # n*d inputs, d*d outputs
    ('sparseDiagonal', 5e-4, models.SparseVectorHunterDiagonal(n, width, depth, subkey2)), # n inputs, n+1 outputs
    ('sparse', 3e-4, models.SparseVectorHunter(n, width, depth, subkey3)), # n+(n(n-1)/2) inputs, n+1+(n(n-1)/2) outputs
